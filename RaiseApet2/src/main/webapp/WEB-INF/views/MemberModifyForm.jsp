...
<body>
	...
	<form action="memberModify" method="POST" enctype="Multipart/form-data">
		<table border=1>
			...
			<tr>
				<td>
					<input type="password" id="userPw" name="userPw" onchange="pwCheck()" value="${sessionScope.loginUser.userPw}">
				</td>
			</tr>
			...
			<tr>
				<td>
					성별 : 남 <input type="radio" id="userGender" name="userGender" value="남">
			...
			<tr>
				<td>
					...
					<input type="hidden" id="userAddress" name="userAddress" value="${sessionScope.loginUser.userAddress}">
				</td>
			</tr>
			
			<tr>
				<td>
					<input type="email" id="userEmail" name="userEmail" value="${sessionScope.loginUser.userEmail}">
				</td>
			</tr>
			
			<tr>
				<td>
					<input type="text" id="userPhone" name="userPhone" value="${sessionScope.loginUser.userPhone}" maxlength="11" readonly>
				</td>
			</tr>
			
			<tr>
				<td>
					<input type="submit" value="수정"><br><input type="reset" value="다시 입력">
				</td>
			</tr>
		</table>
	</form>
	<button onclick="location.href='memberMyPage'">취소</button>
	<!-- 수정 form end -->
</body>
