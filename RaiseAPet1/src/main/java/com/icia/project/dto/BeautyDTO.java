...
public class BeautyDTO {
	...
	// 예약 정보
	private String beautyReserveDate, beautyReserveTime, beautyReserveAnimalKind, beautyReserveAnimalNote, beautyReserveSubject, beautyReserveDesigner, beautyReserveUserName, beautyReservePayment;
