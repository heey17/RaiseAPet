...
<script>
	...
	function pwFind(){
		...
		output += "<input type='text' id='userId' name='userId' placeholder='아이디' maxlength='15'><br>";
		output += "<input type='text' id='userName' name='userName' placeholder='이름' maxlength='5'><br>";
		output += "<div id='confirmDiv'>";
		output += "<input type='email' id='userEmail' name='userEmail' placeholder='이메일' maxlength='50'>";
		output += "<button onclick='pwFindOverlapEmail()'>인증번호 발송</button><br>";
		output += "<input type='text' id='keyConfirm' name='keyConfirm' onchange='keyConfirmEmail()' placeholder='인증번호' maxlength='5'><br>";
		output += "<span id='keyConfirmSpan'></span><br>";
		output += "<input type='button' onclick='pwProcess()' value='비밀번호 찾기'>";
		output += "</div>";
		output += "</div>";
	...
	function idFind(){
		var output = "<div>";
		output += "<input type='text' id='userName' name='userName' placeholder='이름' maxlength='3'><br>";
		output += "<input type='email' id='userEmail' name='userEmail' placeholder='이메일' maxlength='50'><br>";
	...
	function phonePwCheck(){
		var output = "<div>";
		output += "<input type='text' id='userPhone' name='userPhone' placeholder='전화번호' maxlength='11'>";
		output += "<button onclick='pwFindOverlapPhone()'>인증번호 발송</button><br>";
		output += "<input type='text' id='keyConfirm' name='keyConfirm' onchange='keyConfirmPhone()' placeholder='인증번호' maxlength='6'><br>";
		output += "<span id='keyConfirmSpan'></span><br>";
		output += "<input type='button' onclick='pwProcess()' value='비밀번호 찾기'>";
		output += "</div>";
...
<body>
	...
	<div id="findDiv">
		...
		<div id="idOrPwFindDiv">
			...
			<input type="email" id="userEmail" name="userEmail" placeholder="이메일" maxlength="50"><br>
