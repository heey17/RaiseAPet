...
<body>
<form action="eventBoardWrite" name="WriteForm" method="POST" enctype="multipart/form-data">
<table>
	<tr>
		<th>이벤트 썸네일</th>
	...
	<tr>
		<th>이벤트 내용</th>
		<td><textarea name="eventContents"></textarea></td>
	</tr>
	<tr>
		<th>사용할 쿠폰</th>
		<td>
	...
	<tr>
		<td colspan="2"><button onclick="WriteForm.submit()">작성</button></td>
	</tr>
</table>
</form>
</body>
